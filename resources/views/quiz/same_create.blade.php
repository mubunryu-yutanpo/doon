  ...
  <div class="p_form-container">
      <form method="POST" action="{{ route('create') }}">
        ...
        <div class="form-group">
          ...
          <input type="text" name="title" class="form-control @error('title') valid-error @enderror" id="drill_title" value="{{ $drills->title }}" placeholder="※同じ問題集名がある場合、そこにこのクイズが追加されます。" autocomplete="on">
          <!-- error -->
          @error('title')
